        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px", marginBottom: "30px" }}>
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "8px", fontSize: "12px", color: theme.color.ink, lineHeight: "1.4" }}>
              <div>
                <strong>• 20-Year ROI:</strong> A precomputed figure reported directly from federal cohort data (avg_salary and total_cost inputs, keyed by school and credential level). Not estimated or projected by this report.
              </div>
              <div>
                <strong>• Admission Fit:</strong> Measures student academic placement (GPA, SAT) compared to the middle 50% range of the historical freshman cohort. Not applicable at open-admission, test-not-used, or closed institutions.
              </div>
              <div>
                <strong>• Debt-to-Income Ratio:</strong> A published federal outcome label (avg_debt vs. cohort earnings) — reported as-is, not computed or interpreted by this report.
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <p style={{ fontSize: "11px", lineHeight: "1.5", color: theme.color.inkMuted, margin: 0 }}>
              This report is neutral and comparative only — it does not rank, recommend, or select a school. Every figure shown is drawn directly from public federal datasets; none are computed, estimated, or rounded by this report. Where a figure is not published for a school, it is shown as "Not published," never substituted with a typical or estimated value. Confirm all figures directly with each institution before making a decision.
            </p>
          </div>
        </div>
